function [ G ] = PSOfunc2( numofselectedfeatures,numofclusters,newdataset,maxit,npop,population,numofrepres,xmin,xmax )
...
d1=linspace(2,0,maxit);

C1=exp(2*d1);

% C1(round(0.9*maxit):end)=2;

d2=linspace(0,2,maxit);
...
%             particle(i).cost=fitness3(numofselectedfeatures,particle(i).numofclusters,newdataset,particle(i).centroids);
